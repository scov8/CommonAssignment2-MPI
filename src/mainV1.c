...
int main(int argc, char **argv)
{
    ...
    int leftElements = n - (size * (world_size - 1));
    ...
    if (world_rank == 0)
    {
        ...
        //the odd elements that were not passed to any process because they were remainders are processed by the process with rank 0.
